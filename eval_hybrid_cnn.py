...
ART_DIR   = r"D:\Project\TraceFinder\data\results\hybrid_cnn"
MODEL_PATH = r"D:\Project\TraceFinder\data\results\hybrid_cnn\scanner_hybrid_final.keras"#os.path.join(ART_DIR, "scanner_hybrid_final.keras")
ENCODER_PATH = r"D:\Project\TraceFinder\data\results\hybrid_cnn\hybrid_label_encoder.pkl"#os.path.join(ART_DIR, "hybrid_label_encoder.pkl")
SCALER_PATH  = r"D:\Project\TraceFinder\data\results\hybrid_cnn\hybrid_feat_scaler.pkl"#os.path.join(ART_DIR, "hybrid_feat_scaler.pkl")
RES_PATH = r"D:\Project\TraceFinder\data\results\hybrid_cnn\official_wiki_residuals.pkl"#os.path.join(BASE_DIR, "official_wiki_residuals.pkl")
FP_PATH  = r"D:\Project\TraceFinder\data\results\hybrid_cnn\scanner_fingerprints.pkl"#os.path.join(BASE_DIR, "Flatfield/scanner_fingerprints.pkl")
ORDER_NPY = r"D:\Project\TraceFinder\data\results\hybrid_cnn\fp_keys.npy"#os.path.join(BASE_DIR, "Flatfield/fp_keys.npy")
FEATURES_PATH = r"D:\Project\TraceFinder\data\results\hybrid_cnn\features.pkl"#os.path.join(BASE_DIR, "features.pkl")
ENHANCED_PATH = r"D:\Project\TraceFinder\data\results\hybrid_cnn\enhanced_features.pkl"#os.path.join(BASE_DIR, "enhanced_features.pkl")
