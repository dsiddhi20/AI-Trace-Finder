...
RES_PATH  = r"D:\Project\TraceFinder\data\results\hybrid_cnn\official_wiki_residuals.pkl"#os.path.join(BASE_DIR, "../results/hybrid_cnn/official_wiki_residuals.pkl")
FP_PATH   = r"D:\Project\TraceFinder\data\results\hybrid_cnn\scanner_fingerprints.pkl"#os.path.join(BASE_DIR, "../results/hybrid_cnn/scanner_fingerprints.pkl")
ORDER_NPY = r"D:\Project\TraceFinder\data\results\hybrid_cnn\fp_keys.npy" #os.path.join(BASE_DIR, "../results/hybrid_cnn/fp_keys.npy")
FEATURES_PATH = r"D:\Project\TraceFinder\data\results\hybrid_cnn\features.pkl"#os.path.join(BASE_DIR, "../results/hybrid_cnn/features.pkl")
ENHANCED_PATH = r"D:\Project\TraceFinder\data\results\hybrid_cnn\enhanced_features.pkl"#os.path.join(BASE_DIR, "../results/hybrid_cnn/enhanced_features.pkl")
